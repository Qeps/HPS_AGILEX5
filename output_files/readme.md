...
Usage:
    ...
    Ensure your FPGA engineer has compiled the project and pushed golden_top.sof to this directory.

    Ensure the board is powered on and connected via the USB Type-C JTAG cable.
