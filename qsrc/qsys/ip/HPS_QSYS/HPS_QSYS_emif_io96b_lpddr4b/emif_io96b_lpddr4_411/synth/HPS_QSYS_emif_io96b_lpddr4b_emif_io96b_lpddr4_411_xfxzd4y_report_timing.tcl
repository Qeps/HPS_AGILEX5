...
source "$script_dir/HPS_QSYS_emif_io96b_lpddr4b_emif_io96b_lpddr4_411_xfxzd4y_report_timing_core.tcl"
set inst_id 0
...
set instances [emif_get_core_instance_list HPS_QSYS_emif_io96b_lpddr4b_emif_io96b_lpddr4_411_xfxzd4y]
...
foreach { ls_inst } $instances {
   ...
   if { ![dict exists $emif_lockstep_instances $inst] } {
       ...
       dict set emif_lockstep_instances $inst arch HPS_QSYS_emif_io96b_lpddr4b_emif_io96b_lpddr4_411_xfxzd4y
