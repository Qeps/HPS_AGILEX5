...
module io0_HPS_QSYS_emif_io96b_lpddr4b_emif_io96b_lpddr4_411_xfxzd4y_phy_arch_fp_atom_inst_byte_ctrl #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_HPS_QSYS_emif_io96b_lpddr4b_emif_io96b_lpddr4_411_xfxzd4y_atom_attr_byte_ctrl::*;
   ...
   generate 
      if (IS_USED[ID]) begin : gen_used_byte_ctrl
         ...
         tennm_byte_control # (
            ...
            .o_phyctrl_parkclk_to_rxtop_n0_pl1  (o_phyctrl_parkclk_to_rxtop_n0_pl1), .o_phyctrl_parkclk_to_rxtop_n1_pl1  (o_phyctrl_parkclk_to_rxtop_n1_pl1)
         );
