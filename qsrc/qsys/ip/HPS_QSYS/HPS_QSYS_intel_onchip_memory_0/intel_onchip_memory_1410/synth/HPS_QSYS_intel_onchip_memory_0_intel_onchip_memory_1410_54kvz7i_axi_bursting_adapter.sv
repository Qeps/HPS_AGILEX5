...
module  HPS_QSYS_intel_onchip_memory_0_intel_onchip_memory_1410_54kvz7i_axi_bursting_adapter  #(
    ...
    localparam ADDR_MSB         = 11 - ADDR_LSB
)(
    input                               clk,
    input                               reset,
    input        [11:0]           	araddr,
...
logic [11:0] r_ram_wraddr, r_wraddr_lat, w_wraplow_wraddr, r_wraplow_wraddr_lat, r_wraplow_wraddr_lat2;
logic [11:0] w_wrapup_wraddr, r_wrapup_wraddr_lat, r_wrapup_wraddr_lat2;
...
logic [11:0] r_rdaddr_count, w_current_rdaddr, w_ram_rdaddr, r_ram_rdaddr, r_rdaddr_lat;
logic [11:0] w_wraplow_rdaddr, r_wraplow_rdaddr_lat, r_wraplow_rdaddr_lat2, w_current_wraplow_rdaddr;
logic [11:0] w_wrapup_rdaddr, r_wrapup_rdaddr_lat, r_wrapup_rdaddr_lat2, w_current_wrapup_rdaddr;
...
assign w_ram_word_wraddr = r_ram_wraddr[11:ADDR_LSB];
...
assign w_ram_word_rdaddr = w_ram_rdaddr[11:ADDR_LSB];
