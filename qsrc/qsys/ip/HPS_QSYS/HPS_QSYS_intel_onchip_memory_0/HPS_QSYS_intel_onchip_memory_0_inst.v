	HPS_QSYS_intel_onchip_memory_0 u0 (
		.clk        (_connected_to_clk_),        //   input,   width = 1,   clk1.clk
		.s1_arid    (_connected_to_s1_arid_),    //   input,   width = 4, axi_s1.arid
		.s1_araddr  (_connected_to_s1_araddr_),  //   input,  width = 12,       .araddr
		...
		.s1_awid    (_connected_to_s1_awid_),    //   input,   width = 4,       .awid
		.s1_awaddr  (_connected_to_s1_awaddr_),  //   input,  width = 12,       .awaddr
		...
		.s1_rid     (_connected_to_s1_rid_),     //  output,   width = 4,       .rid
		...
		.s1_bid     (_connected_to_s1_bid_),     //  output,   width = 4,       .bid
