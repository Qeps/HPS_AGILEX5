	HPS_QSYS_intel_onchip_memory_0 u0 (
		...
		.s1_arid    (_connected_to_s1_arid_),    //   input,   width = 6, axi_s1.arid
		...
		.s1_awid    (_connected_to_s1_awid_),    //   input,   width = 6,       .awid
		...
		.s1_rid     (_connected_to_s1_rid_),     //  output,   width = 6,       .rid
		...
		.s1_bid     (_connected_to_s1_bid_),     //  output,   width = 6,       .bid
