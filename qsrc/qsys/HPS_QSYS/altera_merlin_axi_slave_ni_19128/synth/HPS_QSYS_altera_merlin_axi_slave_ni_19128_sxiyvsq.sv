...
module HPS_QSYS_altera_merlin_axi_slave_ni_19128_sxiyvsq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    HPS_QSYS_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19128_b3aqu2y #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    HPS_QSYS_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19128_mdgjkuq #(
      .SYMBOLS_PER_BEAT (1),
    ...
    HPS_QSYS_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19128_ou4ij2q #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       HPS_QSYS_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19128_kvw44ga #(
             .SYMBOLS_PER_BEAT (1),
